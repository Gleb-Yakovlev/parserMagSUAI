...
IVTExcel = "./09.04.01 (1).xlsx"        #"./??????????? ? ?????????????? ???????.xlsx" 
ISTExcel = "./09.04.02.xlsx"            #"./?????????????? ??????? ? ??????????.xlsx"
Pribor11Excel = "./12.04.01 (11).xlsx"  #"./??????????????? (11).xlsx"
Pribor12Excel = "./12.04.01 (12).xlsx"  #"./??????????????? (12).xlsx"
ProgInshExcel = "./09.04.04.xlsx"       #"./??????????? ?????????.xlsx"
TTPExcel = "./23.04.01.xlsx"            #"./?????????? ???????????? ?????????.xlsx"
